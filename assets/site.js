...
const COPY = {
  ...
  "zh-CN": {
    ...
    closingCopy: "迹时运动只聚焦乒乓球用户真正需要的部分：动作反馈、比赛数据，以及值得保存的精彩片段。",
    socialTitle: "联系方式",
  ...
  "zh-TW": {
    ...
    closingCopy: "迹时运动只聚焦桌球使用者真正需要的部分：動作回饋、比賽數據，以及值得保存的精彩片段。",
    socialTitle: "聯絡方式",
